...
const Acoplado = ({returnItemsForColumn}) => {
  return (
    <div className='vehicle' >
      <div className='col-span-5 mb-3'>
          ...
          <Position title='DEI' className='box-tire'>
              {returnItemsForColumn('DEI')}
          </Position>
      ...
      <div className='bg-gray-300 border-solid border-black border-t-2 border-r-2 border-l-2 rounded-t-3xl h-28'>
          ...
          <Position title='DED' className='box-tire'>
              {returnItemsForColumn('DED')}
          </Position>
      <div></div>
      <div></div>
      <div className='bg-gray-300 border-solid border-black border-x-2 h-14'></div>
      <div></div>
      <div></div>
